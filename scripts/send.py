...
connection = pika.BlockingConnection(
    pika.ConnectionParameters(host=RABBITMQ_IP, credentials=pika.PlainCredentials("admin", "pass"))
)
...
body = json.dumps({"sample_id": "test123", "uuid": str(uuid.uuid4())}, ensure_ascii=False)
